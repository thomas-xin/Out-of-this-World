execute at @s[tag=!secondary] positioned ~ ~-1 ~ run effect give @e[type=#custom:living,distance=..4] poison 12 2
execute at @s[tag=!secondary] positioned ~ ~-1 ~ run effect give @e[type=#custom:living,distance=..3] wither 12 2
...
execute at @s unless block ~ ~1 ~ #custom:empty as @e[type=trident,distance=..1] at @s run tp @s ~ ~-2 ~
execute at @s unless block ~ ~1 ~ #custom:empty as @e[tag=moved,distance=..1] at @s run tp @s ~ ~.6 ~
