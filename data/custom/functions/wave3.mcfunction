...
effect give @a[distance=..5] instant_damage 3 3
scoreboard players add @e[tag=basic,distance=..4] damaged 12
...
execute as @s[tag=tsunami_w] run fill ^-1 ^-1 ^-2 ^-1 ^2 ^-2 water[level=9] keep
execute as @s[tag=tsunami_w] run fill ^1 ^-1 ^-2 ^1 ^2 ^-2 water[level=9] keep
execute as @s[tag=tsunami_w] run fill ^ ^-1 ^-2 ^ ^2 ^-2 water[level=9] keep
execute as @s[tag=!tsunami_l] positioned ^ ^ ^-4 run fill ~-2.5 ~ ~-2.5 ~2.5 ~6 ~2.5 air replace lava
execute as @s[tag=tsunami_l] run fill ^-1 ^-1 ^-2 ^-1 ^2 ^-2 lava[level=9] keep
execute as @s[tag=tsunami_l] run fill ^1 ^-1 ^-2 ^1 ^2 ^-2 lava[level=9] keep
execute as @s[tag=tsunami_l] run fill ^ ^-1 ^-2 ^ ^2 ^-2 lava[level=9] keep
