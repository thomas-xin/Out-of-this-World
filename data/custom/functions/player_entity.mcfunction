...
execute at @s[tag=trident,nbt={SelectedItem:{id:"minecraft:trident",Count:1b,tag:{HideFlags:53}}},scores={trident=1..}] run effect give @e[tag=killable,distance=.01..4] wither 18 2
execute at @s[tag=trident,nbt={SelectedItem:{id:"minecraft:trident",Count:1b,tag:{HideFlags:53}}},scores={trident=1..}] run effect give @e[tag=killable,distance=.01..4] poison 18 2
