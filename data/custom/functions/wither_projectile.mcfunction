...
execute at @s as @e[tag=victim,sort=nearest,limit=1] if entity @s[distance=72..] run tp @e[tag=projectile,distance=..4] ^ ^ ^ ~ ~-14
execute at @s as @e[tag=victim,sort=nearest,limit=1] if entity @s[distance=96..] run tp @e[tag=projectile,distance=..4] ^ ^ ^ ~ ~-16
