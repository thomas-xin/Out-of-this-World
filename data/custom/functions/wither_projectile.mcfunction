...
execute as @e[tag=s1,limit=1] at @s run tag @a[gamemode=!creative,gamemode=!spectator,distance=16..255] add victim3
...
execute as @e[tag=s2,limit=1] at @s run tag @a[gamemode=!creative,gamemode=!spectator,distance=24..255] add victim3
