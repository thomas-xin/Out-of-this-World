...
execute at @e[tag=nether_labyrinth_entrance] run setblock ~ ~-9 ~ netherite_block
...
execute at @e[tag=bridge,tag=guardian] run setblock ~ ~5 ~ minecraft:spawner{SpawnData:{id:"minecraft:experience_orb",Age:5873,Passengers:[{id:"minecraft:potion",Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionColor:0,CustomPotionEffects:[{Id:2b,Amplifier:1b,Duration:150},{Id:9b,Amplifier:0b,Duration:180},{Id:15b,Amplifier:0b,Duration:120},{Id:16b,Amplifier:0b,Duration:60},{Id:17b,Amplifier:127b,Duration:120},{Id:18b,Amplifier:4b,Duration:900},{Id:27b,Amplifier:127b,Duration:6000},{Id:31b,Amplifier:7b,Duration:9000}],Enchantments:[{}]}}}]}} destroy
...
execute at @e[tag=s_corridor0,tag=!transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge_dark",mirror:"NONE",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge_dark",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor0,tag=transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge",mirror:"NONE",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor0] run setblock ~ ~1 ~ redstone_block destroy

execute at @e[tag=s_corridor1,tag=!transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge_dark",mirror:"NONE",rotation:"CLOCKWISE_90",posX:1,mode:"LOAD",posY:0,posZ:-1,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge_dark",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor1,tag=transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge",mirror:"NONE",rotation:"CLOCKWISE_90",posX:1,mode:"LOAD",posY:0,posZ:-1,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor1] run setblock ~ ~1 ~ redstone_block destroy

execute at @e[tag=s_corridor2,tag=!transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge_dark",mirror:"NONE",rotation:"NONE",posX:-1,mode:"LOAD",posY:0,posZ:-1,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge_dark",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor2,tag=transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge",mirror:"NONE",rotation:"NONE",posX:-1,mode:"LOAD",posY:0,posZ:-1,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor2] run setblock ~ ~1 ~ redstone_block destroy

execute at @e[tag=s_corridor3,tag=!transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge_dark",mirror:"NONE",rotation:"CLOCKWISE_90",posX:2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge_dark",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
execute at @e[tag=s_corridor3,tag=transparent] run setblock ~ ~ ~ structure_block[mode=load]{metadata:"nether_labyrinth_bridge",mirror:"NONE",rotation:"CLOCKWISE_90",posX:2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"custom:nether_labyrinth_bridge",sizeX:5,sizeY:6,sizeZ:5,showboundingbox:1b} destroy
...
execute at @e[tag=s_clear] run fill ~-.5 ~-1 ~-.5 ~.5 ~4 ~.5 air replace tinted_glass
