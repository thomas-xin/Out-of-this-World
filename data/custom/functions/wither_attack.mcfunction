...
execute at @s as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] as @e[tag=wither_rando,distance=..1,sort=random,limit=1] if entity @s[tag=w1] unless entity @e[tag=summontimer,distance=..20,limit=1] positioned ~ ~8.1 ~ unless entity @e[tag=fireball,distance=..2,limit=1] run summon area_effect_cloud ~ ~ ~ {Duration:120,Tags:["fireball","attack","launch","set_id"]}
...
execute at @e[tag=attack] run summon area_effect_cloud ~ ~ ~ {Duration:50,Tags:["glowtimer","launch","set_id"]}
