scoreboard players add @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{HideFlags:13}}},scores={cs_delay=1..}] spur_charge 1
execute at @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{HideFlags:13}}},scores={cs_delay=..-4,spur_charge=9..}] run function custom:spur3
