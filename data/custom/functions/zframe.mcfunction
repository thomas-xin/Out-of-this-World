...
execute if score __slow_loop__ var0 matches 0 if score __entities__ var0 matches 700.. as @e[type=item,tag=!instakill_immune,sort=random,limit=1] unless entity @p[distance=..4] run kill @s
