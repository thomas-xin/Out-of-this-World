...
execute if score __global_delay__ var0 matches 0 if score __entities__ var0 matches 1600.. run kill @e[type=item,tag=!instakill_immune,sort=random,limit=128]
