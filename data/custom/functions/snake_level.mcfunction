...
execute if score @s var0 matches 70.. run scoreboard players set @s var1 3
execute if score @s var0 matches 86.. run tag @s add cs_max

scoreboard players set @s[tag=max] var0 86
...
execute if score @s var1 matches 3 run scoreboard players set @s var3 16
