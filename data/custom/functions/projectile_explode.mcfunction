...
execute at @s[tag=f_proj] run playsound minecraft:item.trident.thunder hostile @a ~ ~ ~ 4 0.
execute at @s[tag=f_proj] run playsound minecraft:block.ender_chest.open hostile @a ~ ~ ~ 7 0.6
...
execute at @s[tag=f_proj,tag=!tri_nuke_2] run summon fireball ~ ~0.6 ~ {Glowing:3b,ExplosionPower:5,Motion:[0.,0.,0.],power:[0.,-.07,0.],Tags:["despawn"]}
execute at @s[tag=d_proj,tag=!tri_nuke_2] run summon creeper ~ ~0.6 ~ {Invulnerable:1b,Fuse:0,powered:1b,ExplosionRadius:2,Tags:["despawn"]}
...
execute at @s[tag=d_proj] positioned ~ ~0.5 ~ run function custom:thrown_powder_snow
execute at @s[tag=d_proj] positioned ~ ~0.5 ~ run function custom:thrown_powder_snow
execute at @s[tag=d_proj] positioned ~ ~0.5 ~ run function custom:thrown_powder_snow
execute at @s[tag=d_proj] positioned ~ ~0.5 ~ run function custom:thrown_powder_snow
execute at @s[tag=d_proj] positioned ~ ~0.5 ~ run function custom:thrown_powder_snow
