...
execute at @s[tag=level_3] anchored eyes run summon fireball ^ ^.8 ^3.6 {ExplosionPower:3,Tags:["level3","despawn","super_missile_launcher_bullet","assign"],Motion:[0.,0.,0.]}
execute at @s[tag=level_3] anchored eyes run summon fireball ^.73 ^-.4 ^3.6 {ExplosionPower:2,Tags:["level3","despawn","super_missile_launcher_bullet","assign"],Motion:[0.,0.,0.]}
execute at @s[tag=level_3] anchored eyes run summon fireball ^-.73 ^-.4 ^3.6 {ExplosionPower:2,Tags:["level3","despawn","super_missile_launcher_bullet","assign"],Motion:[0.,0.,0.]}
