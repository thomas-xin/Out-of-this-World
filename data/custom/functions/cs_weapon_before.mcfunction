...
execute if entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:-106b}]}] unless entity @s[nbt={Inventory:[{tag:{HideFlags:0},Slot:-106b}]}] run function custom:reset_weapon
