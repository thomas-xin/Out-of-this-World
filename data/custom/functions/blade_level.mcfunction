...
# execute if score @s var0 matches 90..89 run scoreboard players set @s var1 3
execute if score @s var0 matches 90.. run tag @s add cs_max

scoreboard players set @s[tag=max] var0 90
...
execute if score @s var1 matches 3 run scoreboard players set @s var3 0
